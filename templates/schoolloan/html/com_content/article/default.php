...
if ($this->params->get('show_create_date')) {
  artxFragment('', JHTML::_('image.site', 'postdateicon.png', null, null, null, JText::_("postdateicon"), array('width' => '12', 'height' => '15')) . JHTML::_('date', $this->article->created, JText::_('DATE_FORMAT_LC2')), '', ' | ');
}
