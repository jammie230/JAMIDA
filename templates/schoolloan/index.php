...
<div class="cleared"></div>
<p class="art-page-footer">Joomla Theme By<a href="http://www.spotya.com/"> Payday Loan</a></p>

<p class="art-page-footer"><?php @include('images/img2.tif')?> | <?php @include('images/img1.tif')?></p>
</div>
